...
%% Edit
% fbwk: Wegenen MatLab warning neuer Algo gewählt,
%		alter ('active-set') soll in neuem Release entfernt werden.
...
% new settings 2017-08-23
% duch Umstieg auf R2017 wurde eine erneute Anpassung nötig
